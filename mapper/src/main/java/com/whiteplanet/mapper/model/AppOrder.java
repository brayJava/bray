...
public class AppOrder {
    ...
    private Boolean isTransFree;

    private Boolean isReceiveFree;

    private Boolean isPatientEvaluated;
    ...
    public Boolean getTransFree() {
        return isTransFree;
    }

    public void setTransFree(Boolean transFree) {
        isTransFree = transFree;
    }

    public Boolean getReceiveFree() {
        return isReceiveFree;
    }

    public void setReceiveFree(Boolean receiveFree) {
        isReceiveFree = receiveFree;
    }
    ...
    public Boolean getPatientEvaluated() {
        return isPatientEvaluated;
    }

    public void setPatientEvaluated(Boolean patientEvaluated) {
        isPatientEvaluated = patientEvaluated;
    }
}