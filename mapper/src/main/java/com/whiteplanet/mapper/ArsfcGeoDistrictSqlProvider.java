...
public class ArsfcGeoDistrictSqlProvider {

    public String insertSelective(ArsfcGeoDistrict record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("arsfc_geo_district");
    ...
    public String updateByPrimaryKeySelective(ArsfcGeoDistrict record) {
        SQL sql = new SQL();
        sql.UPDATE("arsfc_geo_district");
