...
public class AppVersionSqlProvider {
    ...
    public String insertSelective(AppVersion record) {
        ...
        if (record.getConstranintUpdate() != null) {
            VALUES("is_constranint_update", "#{isConstranintUpdate,jdbcType=TINYINT}");
        }

        if (record.getUpdateUrl() != null) {
            VALUES("update_url", "#{updateUrl,jdbcType=VARCHAR}");
        }

        if (record.getMarketUrl() != null) {
            VALUES("market_url", "#{marketUrl,jdbcType=VARCHAR}");
        }
