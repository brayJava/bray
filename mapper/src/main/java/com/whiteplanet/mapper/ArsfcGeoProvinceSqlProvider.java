...
public class ArsfcGeoProvinceSqlProvider {

    public String insertSelective(ArsfcGeoProvince record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("arsfc_geo_province");
    ...
    public String updateByPrimaryKeySelective(ArsfcGeoProvince record) {
        SQL sql = new SQL();
        sql.UPDATE("arsfc_geo_province");
