  ...
  .config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              //    name: 'ui.grid',
              //    files: [
              //        'vendor/modules/angular-ui-grid/ui-grid.js',
              //        'vendor/modules/angular-ui-grid/ui-grid.css'
              //    ]
              //},
              {
                  name:'ng.table',
                  files: [
                      'vendor/modules/ng-table/ng-table.min.js',
                      'vendor/modules/ng-table/ng-table.min.css'
                  ]
              },
              {
